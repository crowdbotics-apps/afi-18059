...
admin.site.site_header = "AFI"
admin.site.site_title = "AFI Admin Portal"
admin.site.index_title = "AFI Admin"
...
schema_view = get_schema_view(
    openapi.Info(
        title="AFI API",
        default_version="v1",
        description="API documentation for AFI App",
    ),
    public=True,
